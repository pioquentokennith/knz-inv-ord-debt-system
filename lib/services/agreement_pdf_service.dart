...
class AgreementPdfService {
  ...
  Future<void> generateAndShare(CustomOrder order, {String ownerName = 'KNZ Scent'}) async {
    await _ensureFonts();
      ...
      build: (pw.Context ctx) => pw.Column(
        ...
        children: [
          ...
          pw.Row(
            ...
            children: [
              pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
                ...
                pw.Text('Custom Perfume Agreement',
                    style: const pw.TextStyle(fontSize: 13, color: PdfColors.grey700)),
              ]),
              pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.end, children: [
                pw.Text('Date: ${dateFmt.format(order.createdAt)}',
                    style: const pw.TextStyle(fontSize: 9, color: PdfColors.grey600)),
                pw.Text('Ref: ${order.id.substring(0, 8).toUpperCase()}',
                    style: const pw.TextStyle(fontSize: 9, color: PdfColors.grey600)),
              ]),
            ],
          ),
          ...
          pw.Container(
            ...
            child: pw.Text(order.fragranceSpecs,
          ...
          pw.Table(
            ...
            children: [
              ...
              _tableRow(['Balance Due', currency.format(order.balanceDue)], bold: true),
            ],
          ),
          pw.SizedBox(height: 14),
          ...
          pw.SizedBox(height: 6),
          _infoRow('Target Delivery Date', dateFmt.format(order.deliveryDate)),
          pw.SizedBox(height: 14),
  ...
  static pw.TableRow _tableRow(List<String> cells,
    ...
    final fg = isHeader ? PdfColors.white   : (bold ? PdfColors.grey900 : PdfColors.grey700);
    return pw.TableRow(
  ...
  static pw.Widget _signatureBlock(String role, String name) =>
      pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.center, children: [
        pw.Container(width: 120, height: 0.5,
            color: PdfColors.grey600),
